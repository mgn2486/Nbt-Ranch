...
var SignUpComponent = /** @class */ (function () {
    function SignUpComponent(userService, toastr, fb) {
        ...
        this.hasError = function (controlName, errorName) {
            return _this.SignUpForm.controls[controlName].hasError(errorName);
        };
    }
    SignUpComponent.prototype.ngOnInit = function () {
        ...
        this.SignUpForm.valueChanges.subscribe(function (data) {
            _this.logValidationErrors(_this.SignUpForm);
        });
    };
    // Logs validation error messages
    SignUpComponent.prototype.logValidationErrors = function (group) {
        var _this = this;
        if (group === void 0) { group = this.SignUpForm; }
        Object.keys(group.controls).forEach(function (key) {
            var abstractControl = group.get(key);
            _this.formErrors[key] = '';
            if (abstractControl && !abstractControl.valid
    ...
    SignUpComponent.prototype.OnSubmit = function (form) {
        ...
        this.userService.registerUser(userData)
            ...
            if (data.succeeded == true) {
                ...
                _this.toastr.error(data.errors[0].description);
        });
    };
